...
import { parseLessonsInput, ParsedLessonItem } from '../../utils/lessonParser';
import {
  X,
  Layers,
  FileText,
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Автоматичне розпізнавання класів, дат, номерів та тем із тексту або файлу
              </p>
            </div>
          </div>
          <button
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-xs">
              <label className="font-semibold text-slate-700 uppercase tracking-wider">
                Текст розкладу або планування:
              </label>
              <div className="flex items-center gap-2">
                <span className="text-slate-400">Зразки для перевірки:</span>
                <button
                  type="button"
            ...
            <textarea
              ...
              placeholder="Вставте рядки з датами, класами та темами. Наприклад:&#10;01.09.2026 | 6-А | 1 | Вступний урок&#10;02.09.2026 | 10-В | 1 | Grammar practice"
                ...
                <table className="w-full text-left text-xs border-collapse">
                  <thead className="bg-slate-100 sticky top-0 z-10 text-[11px] text-slate-600 uppercase tracking-wider font-semibold border-b border-slate-200">
                    <tr>
                      ...
                      <th className="py-2.5 px-3 w-36">Дата</th>
                      <th className="py-2.5 px-3 w-28">Клас</th>
                      <th className="py-2.5 px-3 w-20">№ уроку</th>
                      ...
                      >
                        ...
                        <td className="py-2 px-3">
                          <input
                            ...
                            className="px-2 py-1 border border-slate-200 rounded-lg text-xs w-full text-center focus:ring-1 focus:ring-indigo-500"
                          />
                        </td>
                        <td className="py-2 px-3">
                          <input
                        ...
                        <td className="py-2 px-3 text-center">
                          {row.isDuplicate ? (
                            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-amber-100 text-amber-800">
                              <AlertTriangle className="w-3 h-3 text-amber-600" /> Вже існує
                            </span>
                          ) : (
