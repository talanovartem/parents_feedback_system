      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden border border-slate-200">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/70">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold text-base shadow-xs">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 transition shadow-xs"
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 transition shadow-xs"
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {student.notes && (
            <div className="p-3 rounded-xl bg-amber-50 border border-amber-200/80 flex items-start gap-2.5">
              <span className="text-amber-600 font-semibold text-xs whitespace-nowrap pt-0.5">
                Контекст учня:
              </span>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80">
              <span className="text-xs text-slate-500 font-medium">Тренд динаміки</span>
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80">
            ...
            {pointsWithScores.length === 0 ? (
              ...
              <div className="relative w-full overflow-x-auto">
                ...
                {hoveredPoint && (
                  <div
                    className="absolute top-2 right-4 bg-slate-900/90 text-white text-xs px-3 py-2 rounded-lg shadow-lg pointer-events-none transition-all duration-150 border border-slate-700"
                  >
                  ...
                  >
                    ...
                    {!p.absent && (
                      <div className="flex items-center gap-2 sm:self-center self-end">
                        <span className="text-xs text-slate-500">Середній:</span>
